...
# small change of changing bordercolor from green to red
borderColor:    .word	0xff0000	 # red (originally green) 
FruitColor2: .word 0xcc6611
...
gameSpeed:	.word 200 #originally 200
...
ColorTable: .word 0xcc6611, 0xcf00ff, 0x00FFE7, 0x09FF00 # hexcodes for Orange, Purple, Cyan, and LightGreen respectively (this is part of our optimization)
.text
...
######################################################	
SpawnFruit:
#set Orange fruit to a different fixed position
	li $v0, 42
	li $a1, 1
	syscall 
	sw $a0, FruitState
